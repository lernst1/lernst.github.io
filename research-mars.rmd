---
title: " "
pagetitle: "Lonnie Ernst | Mars O2 Research"
output:
  html_document:
    theme: flatly
    toc: false
...
Ultimately, this project produced indeterminate results. A 1% increase in O₂ was observed over the course of the experiment, which could indicate photosynthetic activity; however, this could not be confirmed. The CO₂ sensors had a maximum detection threshold of 100,000 ppm; since the chamber was back-filled with 98% CO₂ (approximately 980,000 ppm), the sensors were saturated from the outset and incapable of detecting any decline in CO₂ regardless of whether it was being consumed. Without a recorded baseline CO₂ value and with sensors operating beyond their detection range, it was not possible to establish a correlation between the O₂ increase and CO₂ consumption, the two measurements needed to confirm photosynthesis were occurring.

The culture gradually turned from deep green to white over the course of the experiment. While initial discoloration could be attributed to photobleaching from the lamp, the most likely explanation is that the culture died under the extreme CO₂ conditions, which would also account for why O₂ levels did not continue to rise.

<div class="comparison-row">
<figure class="comparison-img">
<img src="images/mars-before.jpeg" alt="N. muscorum culture at start: deep green">
<figcaption>Day 0: N. muscorum culture &ndash; deep green</figcaption>
</figure>
<figure class="comparison-img">
